...
class ControlEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.max_impulse = 1
        self.viewer = None
        self.gen_bounds = np.array([self.max_pos, self.max_speed])
        self.obs_bounds = np.array([self.max_pos, np.inf])
        self.act_bounds=np.array([self.max_impulse])
    ...
    def render(self, mode='human'):
        ...
        self.transform.set_translation(self.state[0],0.0)
